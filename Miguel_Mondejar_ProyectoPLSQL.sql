...
peso POKEDEX.PESO%TYPE, altura POKEDEX.ALTURA%TYPE) AS
...
CREATE OR REPLACE PROCEDURE deletePokemon (nombre_poke POKEMON.NOMBRE%TYPE) AS
BEGIN
...
-- de la región. 
CREATE OR REPLACE PROCEDURE datosRegion (region_nombre REGION.NOMBRE_REGION%TYPE) AS
